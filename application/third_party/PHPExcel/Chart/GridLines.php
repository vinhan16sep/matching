...
class PHPExcel_Chart_GridLines extends PHPExcel_Chart_Properties
{
  ...
  /**
   * Properties of Class:
   * Object State (State for Minor Tick Mark) @variables bool
   * Line Properties @variables  array of mixed
   * Shadow Properties @variables  array of mixed
   * Glow Properties @variables  array of mixed
   * Soft Properties @variables  array of mixed
   *
   */
