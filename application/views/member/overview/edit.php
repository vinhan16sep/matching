    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-group">
                ...
                <?php echo form_textarea('certificate', $temp_register['certificate'], 'class="form-control"'); ?>
            </div>
            <div class="form-group">
                <?php echo form_label('Mong muốn hợp tác: ', 'desire'); ?>
                <?php echo form_error('desire', '<div class="error">', '</div>'); ?>
                <?php echo form_textarea('desire', $temp_register['desire'], 'class="form-control"'); ?>
            </div>
            <div class="form-group">
