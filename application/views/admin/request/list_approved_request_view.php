...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-body">
            <?php
            echo form_open_multipart(base_url('admin/request/approved'), array('class' => 'form-horizontal', 'method' => 'GET'));
            ?>
            <div class="row">
                <div class="column">
                ...
                <div class="column">
                    <div class="form-group col-sm-12 text-left" style="padding-left: 0 !important;">
                        ...
                        ?>
                        <a class="btn btn-outline-primary" href="<?php echo base_url('admin/request/approved') ?>"><i class="fa fa-repeat" aria-hidden="true" style="color: red"></i></a>
                    </div>
                </div>
            </div>
